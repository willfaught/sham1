(module compiler-test mzscheme
  ...
  (define compiler-test-suite
    (test-suite "compiler"
                ...
                (test-case-e "sc-ch1" ":scheme Char \"schemeCharacter\"" #\a)
                (test-case-x "sc-ch2" ":scheme Char \"schemeFloat\"")
                (test-case-x "sc-ch3" ":scheme Char \"schemeFunction\"")
                (test-case-x "sc-ch4" ":scheme Char \"schemeInteger\"")
                (test-case-x "sc-ch5" ":scheme Char \"schemeList1\"")
                (test-case-x "sc-ch6" ":scheme Char \"schemeTuple\"")
                (test-case-x "sc-fl1" ":scheme Float \"schemeCharacter\"")
                (test-case-e "sc-fl2" ":scheme Float \"schemeFloat\"" 1.2)
                (test-case-x "sc-fl3" ":scheme Float \"schemeFunction\"")
                (test-case-e "sc-fl4" ":scheme Float \"schemeInteger\"" 1)
                (test-case-x "sc-fl5" ":scheme Float \"schemeList1\"")
                (test-case-x "sc-fl6" ":scheme Float \"schemeTuple\"")
                (test-case-fx "sc-fu1" ":scheme a -> a \"schemeCharacter\"" (lambda (x) (x (delay 1))))
                (test-case-fx "sc-fu2" ":scheme a -> a \"schemeFloat\"" (lambda (x) (x (delay 1))))
                (test-case-p "sc-fu3" ":scheme a -> a \"schemeFunction\"" (lambda (x) (equal? (x (delay 1)) 1)))
                (test-case-fx "sc-fu4" ":scheme a -> a \"schemeInteger\"" (lambda (x) (x (delay 1))))
                ...
                (test-case-e "sc-in4" ":scheme Int \"schemeInteger\"" 1)
                (test-case-x "sc-in5" ":scheme Int \"schemeList1\"")
                (test-case-x "sc-in6" ":scheme Int \"schemeTuple\"")
                (test-case-x "sc-li1" ":scheme [a] \"schemeCharacter\"")
                (test-case-x "sc-li2" ":scheme [a] \"schemeFloat\"")
                (test-case-x "sc-li3" ":scheme [a] \"schemeFunction\"")
                (test-case-x "sc-li4" ":scheme [a] \"schemeInteger\"")
                (test-case-e "sc-li5" ":scheme [a] \"schemeList1\"" null)
                (test-case-e "sc-li5" ":scheme [a] \"schemeList2\"" (cons (delay 1) (delay null)))
                (test-case-x "sc-li6" ":scheme [a] \"schemeTuple\"")
                (test-case-x "sc-tu1" ":scheme (Int, Int) \"schemeCharacter\"")
                (test-case-x "sc-tu2" ":scheme (Int, Int) \"schemeFloat\"")
                (test-case-x "sc-tu3" ":scheme (Int, Int) \"schemeFunction\"")
                (test-case-x "sc-tu4" ":scheme (Int, Int) \"schemeInteger\"")
                (test-case-x "sc-tu5" ":scheme (Int, Int) \"schemeList1\"")
                (test-case-e "sc-tu6" ":scheme (Int, Int) \"schemeTuple\"" (vector-immutable (delay 1) (delay 2)))

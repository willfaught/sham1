(module Transformation scheme
  ...
  (define preludeTypes
    (let* ((typeParsers (parsers "Transformation"))
      ...
      (list (list "False" (parseT "Haskell.Prelude.Bool"))
            (list "True" (parseT "Haskell.Prelude.Bool"))
            (list "error" (parseT "[Haskell.Prelude.Char] -> a"))
            (list "floatAdd" (parseT "Haskell.Prelude.Float -> Haskell.Prelude.Float -> Haskell.Prelude.Float"))
            (list "floatDivide" (parseT "Haskell.Prelude.Float -> Haskell.Prelude.Float -> Haskell.Prelude.Float"))
            (list "floatMultiply" (parseT "Haskell.Prelude.Float -> Haskell.Prelude.Float -> Haskell.Prelude.Float"))
            (list "floatSubtract" (parseT "Haskell.Prelude.Float -> Haskell.Prelude.Float -> Haskell.Prelude.Float"))
            (list "fst" (parseT "(a, b) -> a"))
            (list "head" (parseT "[a] -> a"))
            (list "intAdd" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Int"))
            (list "intDivide" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Int"))
            (list "intMultiply" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Int"))
            (list "intSubtract" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Int"))
            (list "isFalse" (parseT "Haskell.Prelude.Bool -> Haskell.Prelude.Bool"))
            (list "isTrue" (parseT "Haskell.Prelude.Bool -> Haskell.Prelude.Bool"))
            (list "null" (parseT "[a] -> Bool"))
            (list "snd" (parseT "(a, b) -> b"))
            (list "tail" (parseT "[a] -> [a]"))
            (list ":" (parseT "a -> [a] -> [a]"))
            (list "+" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Int"))
            (list "-" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Int"))
            (list "*" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Int"))
            (list "/" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Int"))
            (list "==" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Bool"))
            (list "/=" (parseT "Haskell.Prelude.Int -> Haskell.Prelude.Int -> Haskell.Prelude.Bool")))))

(module Transformation scheme
  ...
  (define preludeTypes
    (let* ((typeParsers (parsers "Transformation"))
      ...
      (list (list "False" (parseT "Bool"))
            (list "Nil" (parseT "[a]"))
            (list "True" (parseT "Bool"))
            (list "Unit" (parseT "()"))
            (list "charEquals" (parseT "Char -> Char -> Bool"))
            (list "error" (parseT "[Char] -> a"))
            (list "floatAdd" (parseT "Float -> Float -> Float"))
            (list "floatDivide" (parseT "Float -> Float -> Float"))
            (list "floatEquals" (parseT "Float -> Float -> Bool"))
            ...
            (list "/" (parseT "Int -> Int -> Int"))
            (list "intEquals" (parseT "Int -> Int -> Bool"))
            (list "==" (parseT "Int -> Int -> Bool"))
            (list "intMultiply" (parseT "Int -> Int -> Int"))
            (list "*" (parseT "Int -> Int -> Int"))
            (list "intSubtract" (parseT "Int -> Int -> Int"))
            (list "-" (parseT "Int -> Int -> Int"))
            (list "isFalse" (parseT "Bool -> Bool"))
            (list "isLower" (parseT "Char -> Bool"))
            (list "isTrue" (parseT "Bool -> Bool"))
            (list "isUpper" (parseT "Char -> Bool"))
            (list "null" (parseT "[a] -> Bool"))
            (list "snd" (parseT "(a, b) -> b"))
            (list "tail" (parseT "[a] -> [a]"))
            (list "toLower" (parseT "Char -> Char"))
            (list "toUpper" (parseT "Char -> Char"))
            (list ":" (parseT "a -> [a] -> [a]"))
            (list "/=" (parseT "Int -> Int -> Bool")))))

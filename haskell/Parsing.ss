  ...
  (define (languageParsers source-name)
    (parser (src-pos)
            ...
            (grammar (nt-module ((t-module nt-modid t-where nt-body) (make-Module $2 null (list-ref $4 0) (list-ref $4 1)))
                     ...
                     (nt-impdecl ((t-import nt-impdecl-2 t-string t-varid nt-modid nt-impdecl-3)
                                  (if (not (equal? $4 "as")) (varidError "as" $4) (make-Import $2 (charsToString $3) $5 $6))))
                     (nt-impdecl-2 (() #f)
                     ...
                     (nt-import ((t-string t-varid nt-cname) (if (not (equal? $2 "as")) (varidError "as" $2) (list (charsToString $1) $3))))
                     (nt-cname ((nt-var) $1)
                               ((nt-con) $1))
                     (nt-topdecls (() null)

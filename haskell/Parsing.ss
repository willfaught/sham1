    ...
    (parser (src-pos)
            ...
            (grammar (nt-module ((t-module nt-modid nt-exports t-where nt-body) (make-Module $2 $3 (list-ref $5 0) (list-ref $5 1)))
                     ...
                     (nt-impdecls ((nt-impdecls t-semicolon nt-impdecl) (cons $3 $1))
                                  ((nt-impdecl) (list $1)))
                     (nt-impdecl ((t-import t-varid nt-modpath t-lrbracket nt-imports t-rrbracket)
                                  (if (not (or (equal? $2 "haskell")
                                               (equal? $2 "ml")
                                               (equal? $2 "scheme")))
                                      (varidError "'haskell' or 'ml' or 'scheme'" $2)
                                      (make-Impdecl $2 (map charsToString $3) $5))))

  ...
  (define/contract reconstructType (-> (listof Assumption?) c/CoreSyntax? (list/c t/Type? (listof Constraint?)))
    (lambda (context syntax)
      (match syntax
        ...
        (($ c/ML t _) (list (let ((t (generalize context (transformType t)))) (if (Forall? t) (instantiate t) t)) null))
        (($ c/Scheme t _) (list (let ((t (generalize context (transformType t)))) (if (Forall? t) (instantiate t) t)) null))

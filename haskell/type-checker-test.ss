(module type-checker-test mzscheme
  ...
  (define typechecker-test-suite
    (test-suite "typechecker"
                ...
                (test-case-x "id1" "x")
                (test-case-e "id2" "fst" "(t, t1) -> t")
                (test-case-e "id3" "head" "[t] -> t")
                (test-case-e "id4" "isFalse" "Bool -> Bool")
                (test-case-e "id5" "isTrue" "Bool -> Bool")
                (test-case-e "id6" "null" "[t] -> Bool")
                (test-case-e "id7" "snd" "(t, t1) -> t1")
                (test-case-e "id8" "tail" "[t] -> [t]")

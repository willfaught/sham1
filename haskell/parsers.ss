    ...
    (parser (src-pos)
            ...
            (error (lambda (token-ok token-name token-value start-pos end-pos)
                     (raise-read-error (format "error: malformed ~a (~a ~a:~a): ~a"
                                       ...
                                       (position-offset start-pos)
                                       (- (position-offset end-pos) (position-offset start-pos)))))
            (grammar (nt-module ((t-module nt-modid t-where nt-body) (make-module-term $2 (car $4) (cdr $4)))
                                ((nt-body) (make-module-term "none" (car $1) (cdr $1))))
                     (nt-modid ((t-conid) $1))
                     (nt-body ((t-lcbracket nt-impdecls t-semicolon nt-topdecls t-rcbracket) (cons $2 $4))
                     ...
                     (nt-impdecl ((t-import t-string) (make-import-term (foldr (lambda (x y) (string-append (character-term-character x) y)) "" $2) #f))
                                 ((t-import t-varid t-string t-varid nt-modid)
                                  (cond ((not (equal? $2 "qualified"))
                                         (error (format "expected 'qualified', found '~a'" $2)))
                                        ((not (equal? $4 "as"))
                                         (error (format "expected 'as', found '~a'" $4)))
                                        (else (make-import-term (foldr (lambda (x y) (string-append (character-term-character x) y)) "" $3) $5)))))
                     (nt-topdecls (() null)
                     ...
                     (nt-fielddecl ((nt-vars t-coloncolon nt-type) (map (lambda (x) (make-field-term x $3)) $1)))
                     (nt-decls ((t-lcbracket nt-decls-2 t-rcbracket) $2))
                     (nt-decls-2 (() null)
                                 ((nt-decl nt-decls-3) (cons $1 $2)))
                     (nt-decls-3 (() null)
                                 ((t-semicolon nt-decl nt-decls-3) (cons $2 $3)))
                     (nt-decl ((nt-funlhs nt-rhs) (make-declaration-term $1 $2)))
                     ...
                     (nt-exp ((t-backslash nt-exp-2 t-singlearrow nt-exp) (make-function-term $2 $4))
                     ...
                     (nt-gcon ((t-lrbracket t-rrbracket) (make-identifier-term "()"))
                              ((t-lsbracket t-rsbracket) (make-list-term null))
                     ...
                     (nt-apat ((nt-var) $1))
                     (nt-type ((nt-btype nt-type-2) (if (null? $2) $1 (foldr1 (lambda (x y) (make-function-type x y)) (cons $1 $2)))))
                     (nt-type-2 (() null)

(module compiler-test mzscheme
  ...
  (define compiler-test-suite
    (test-suite "compiler"
                ...
                (test-case-p "id3" "(:)" (lambda (x) (strict-equal? ((x (delay 1)) (delay (cons (delay 2) (delay null))))
                                                                    (cons (delay 1) (delay (cons (delay 2) (delay null)))))))
                (test-case-p "id4" "head" (lambda (x) (equal? (x (delay (cons (delay 1) (delay null)))) 1)))
  ...
  ; ml-function :: boolean -> boolean
  (define ml-function (lambda (x) (not x)))
  ...
  (define ml:types `(("ml-boolean" ,(make-type-constructor "Bool"))
                     ...
                     ("ml-function" ,(make-function-type (make-type-constructor "Bool")

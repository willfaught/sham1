  ...
  (define (haskell-parser source-name)
    (parser (src-pos)
            ...
            (grammar (nt-module ((t-module nt-modid t-where nt-body) (make-tmod $2 $4))
                     ...
                     (nt-fexp ((nt-aexp nt-fexp-2) (if (null? $2) $1 (make-tapp $1 $2))))
                     (nt-btype-2 (() null)
                                 ((nt-btype) null))
                     ...
                     (nt-aexp ((nt-qvar) $1)
                              ((nt-gcon) $1)
                              ((nt-literal) $1)
                              ((t-lrbracket nt-exp nt-aexp-2 t-rrbracket) (if (null? $3) $2 (make-ttup (cons $2 $3))))
                     ...
                     (nt-gcon ((t-rbracketcon) (make-ttup null))
                              ((t-sbracketcon) (make-tlist null))
                              ((t-lrbracket t-comma nt-gcon-2 t-rrbracket) (make-ttupcon (+ $3 2)))
                              ((nt-qcon) $1))
                     (nt-literal ((t-integer) (make-tnum $1))
                                 ((t-float) (make-tnum $1))
                                 ((t-char) (make-tchar $1))
                                 ((t-string) (make-tlist $1)))
                     (nt-aexp-2 (() null)
                                ((t-comma nt-exp nt-aexp-2) (cons $2 $3)))
                     (nt-qvarid ((t-varid) (make-tid $1)))
                     (nt-qvarsym ((t-varsym) (make-tid $1)))
                     (nt-gcon-2 (() 0)

  ...
  (define (haskell-parser source-name)
    (parser (src-pos)
            ...
            (grammar (nt-module ((t-module nt-modid t-where nt-body) (make-tmod $2 $4))
                     ...
                     (nt-topdecls-2 (() null)
                                    ((t-semicolon nt-topdecl nt-topdecls-2) (cons $1 $2)))
                     (nt-decl ((nt-gendecl) 'TODO)
                              ((nt-decl-2 nt-rhs) (make-tfdecl (list-ref $1 0) (list-ref $1 1) $2)))
                     ...
                     (nt-alts ((nt-alt nt-alts-2) 'TODO))
                     (nt-fexp ((nt-aexp nt-fexp-2) (cons $1 $2))
                     (nt-btype-2 (() null)
                                 ((nt-btype) $1))
                     ...
                     (nt-aexp ((nt-qvar) $1)
                              ((nt-gcon) $1)
                              ((nt-literal) $1)
                              ((t-lrbracket nt-exp nt-aexp-2 t-rrbracket) (make-tlist $2 $3))
                              ((t-lsbracket nt-exp nt-aexp-2 t-rsbracket) (make-ttup $2 $3)))
                     (nt-tyvar ((t-varid) $1))
                     (nt-atype-2 (() null)
                     ...
                     (nt-gcon ((t-rbracketcon) (make-ttup 'empty-tuple 'empty-tuple))
                              ((t-sbracketcon) (make-tlist 'empty-list 'empty-list))
                              ((t-lrbracket t-comma nt-gcon-2 t-rrbracket) 'TODO)
                              ((nt-qcon) $1))
                     (nt-literal ((t-integer) (make-tnum $1))
                                 ((t-float) (make-tnum $1))
                                 ((t-char) (make-tchar $1))
                                 ((t-string) (string-to-list $1)))
                     (nt-aexp-2 (() 'empty-list)
                                ((t-comma nt-exp nt-aexp-2) (make-tlist $2 $3)))
                     (nt-qvarid ((t-varid) $1))
                     ...
                     (nt-qconid ((t-conid) (make-tid $1)))
                     (nt-gconsym ((t-colon) (make-tid $1))
                                 ((nt-qconsym) $1))

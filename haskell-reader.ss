(module haskell-reader mzscheme
  ...
  (define string-lexer
    (lexer ((:or (:- a-graphic (:or #\" #\\)) a-space a-escape) (cons (make-echar lexeme) (string-lexer input-port)))
    ...
    (parser (src-pos)
            ...
            (error (lambda (token-ok token-name token-value start-pos end-pos)
                     (raise-read-error (format "error: malformed ~a (~a ~a:~a): ~a"
                                       ...
                                       (position-offset start-pos)
                                       (- (position-offset end-pos) (position-offset start-pos)))))
            (grammar (nt-module ((t-module nt-modid t-where nt-body) (make-emod $2 $4))
                                ((nt-body) (make-emod "none" $1)))
                     (nt-modid ((t-conid) $1))
                     ...
                     (nt-decl ((nt-gendecl) 'TODO)
                              ((nt-decl-2 nt-rhs) (make-edecl $1 $2)))
                     ...
                     (nt-exp ((t-backslash nt-exp-2 t-singlearrow nt-exp) (make-efun $2 $4))
                             ((t-let nt-decls t-in nt-exp) (make-elet $2 $4))
                     ...
                     (nt-fexp ((nt-aexp nt-fexp-2) (if (null? $2) $1 (make-eapp $1 $2))))
                     (nt-btype-2 (() null)
                                 ((nt-btype) null))
                     (nt-atype ((nt-tyvar) (make-tvariable $1))
                               ((t-lrbracket nt-type t-comma nt-type nt-atype-2 t-rrbracket) (make-ttuple (cons $2 (cons $4 $5))))
                               ((t-lsbracket nt-type t-rsbracket) (make-tlist $2)))
                     (nt-decls-2 (() null)
                     ...
                     (nt-aexp ((nt-qvar) $1)
                              ((nt-gcon) $1)
                              ((nt-literal) $1)
                              ((t-lrbracket nt-exp nt-aexp-2 t-rrbracket) (if (null? $3) $2 (make-etup (cons $2 $3))))
                              ((t-lsbracket nt-exp nt-aexp-2 t-rsbracket) (make-elist (cons $2 $3))))
                     (nt-tyvar ((t-varid) $1))
                     (nt-atype-2 (() null)
                     ...
                     (nt-gcon ((t-rbracketcon) 'TODO)
                              ((t-sbracketcon) (make-elist null))
                              ((t-lrbracket t-comma nt-gcon-2 t-rrbracket) (make-etupcon (+ $3 2)))
                              ((nt-qcon) $1))
                     (nt-literal ((t-integer) (make-enum $1))
                                 ((t-float) (make-enum $1))
                                 ((t-char) (make-echar $1))
                                 ((t-string) (make-elist $1)))
                     (nt-aexp-2 (() null)
                                ((t-comma nt-exp nt-aexp-2) (cons $2 $3)))
                     (nt-qvarid ((t-varid) (make-eid $1)))
                     (nt-qvarsym ((t-varsym) (make-eid $1)))
                     (nt-gcon-2 (() 0)
                                ((t-comma nt-gcon-2) (+ $2 1)))
                     (nt-qcon ((nt-qconid) $1)
                              ((t-lrbracket nt-gconsym t-rrbracket) $2))
                     (nt-qconid ((t-conid) (make-eid $1)))
                     (nt-gconsym ((t-colon) (make-eid ":"))
                                 ((nt-qconsym) $1))
                     (nt-qconsym ((t-consym) (make-eid $1))))))

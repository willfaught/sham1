(module reader mzscheme
  ...
  (define (parser-error source-name)
  ...
  (define (pattern-parser source-name)
    (parser (src-pos)
            (tokens keywords regular)
            (start nt-apat)
            (end eof)
            (error (parser-error source-name))
            (grammar (nt-apat ((nt-var) $1))
                     (nt-var ((t-varid) $1)
  ...
  (define (type-parser source-name)
    (parser (src-pos)
            ...
            (end eof)
            (error (parser-error source-name))
            (grammar (nt-type ((nt-btype nt-type-2) (if (null? $2) $1 (make-function-type (cons $1 $2)))))
                     (nt-type-2 (() null)
  ...
  (define (expression-parser source-name)
    (parser (src-pos)
            ...
            (end eof)
            (error (parser-error source-name))
            (debug "reader.ss.debug")
            (grammar (nt-exp ((t-backslash nt-apat nt-exp-2 t-singlearrow nt-exp) (make-function-term (cons $2 $3) $5))
                     ...
                     (nt-apat (() (pattern-parser source-name)))
                     (nt-decls (() (declarations-parser source-name)))
                     ...
                     (nt-type (() (type-parser source-name))))))
  
  #;(define (declarations-parser source-name)
    (parser (src-pos)
            (tokens keywords regular)
            (start nt-decls)
            (end eof)
            (error (parser-error source-name))
            (grammar (nt-decls ((t-lcbracket nt-decls-2 t-rcbracket) $2))
                     (nt-decls-2 (() null)
                     ...
                     (nt-exp (() (expression-parser source-name))))))
    ...
    (parser (src-pos)
            ...
            (grammar (nt-module ((t-module nt-modid t-where nt-body) (make-module-term $2 $4))
                     ...
                     (nt-decl ((nt-gendecl) 'TODO)
                              ((nt-decl-2 nt-rhs) (make-declaration-term $1 $2)))

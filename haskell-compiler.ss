(module haskell-compiler mzscheme
  ...
  (define (compile-module-term i d)
    (define compile-declaration-term
      (match-lambda
  ...
  (define tests
      (list (make-test "eapp 1"
            ...
            (make-test "elet 1"
                       (make-let-term (list (make-declaration-term (list "x") (make-integer-term "2"))) (make-integer-term "3"))
                       '(begin (define x (delay 2)) 3))
            (make-test "elet 2"
                       (make-let-term (list (make-declaration-term (list "x") (make-integer-term "2")) (make-declaration-term (list "y") (make-integer-term "3"))) (make-integer-term "4"))
